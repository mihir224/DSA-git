...
public class PGStudent extends Student {
    ...
    public PGStudent(String name, int regNo, long phn, String fName, String currentAddress, String permanentAddress, String email, double marks, String pastQualifications){
